...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // move the ownership of the edge to the parent node
    ...
    // local instantiation of chatbot to be moved to rootnode
    ...
    rootNode->MoveChatbotHere(std::move(chatBot)); //move the chatbot to the root node
}
